    ...
    return (
        <div className="flex flex-col min-h-screen">
            <main className="flex-1 overflow-visible">
                <HomeWithLoading>
                    <div id="home-page-wrap" className="overflow-visible">
                        {/* Hero Section */}
                        ...
                        <section className="reveal px-4 sm:px-6 lg:px-8 py-16 bg-zinc-800/50">
                            <StatsSection />
                        </section>

                        {/* Features Section with reveal */}
                        <section className="reveal px-4 sm:px-6 lg:px-8 py-16 bg-zinc-800">
                            <FeaturesSection />
                        </section>
                    </div>
                </HomeWithLoading>
